...
- **Application တစ်ခုချင်းစီအလိုက် width သတ်မှတ်ပေးခြင်း** — ကွဲပြားသော software များသည် မြန်မာစာလုံး/သင်္ကေတတစ်ခု၏ အကျယ် (width) ကို ကွဲပြားစွာ ယူဆကြသည်။ Myanso သည် လက်ရှိအသုံးပြုနေသော app (foreground app) ကို အလိုအလျောက် သိရှိပြီး ၎င်းနှင့် ကိုက်ညီအောင် ညှိပေးသည်။ ထို့ကြောင့် zsh, vim, agy နှင့် Claude Code တို့တွင် cursor နှင့် column များသည် လွဲချော်ခြင်းမရှိဘဲ တစ်တန်းတည်း ရှိနေမည် ဖြစ်သည် (အောက်တွင် ဆက်လက်ဖတ်ရှုပါ)။
...
စနစ်တကျ စစ်ဆေးသည့် test သို့မဟုတ် linter များမရှိပါ — စစ်ဆေးခြင်းကို manual သာ လုပ်ဆောင်ရပါမည် - shell၊ vim နှင့် Claude Code သို့မဟုတ် agy ကဲ့သို့သော TUI များတွင် မြန်မာစာများကို ရိုက်ထည့်ခြင်း သို့မဟုတ် paste ပြုလုပ်ခြင်းဖြင့် စစ်ဆေးနိုင်သည်။
